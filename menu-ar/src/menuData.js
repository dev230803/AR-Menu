...
export const dishes = [
  ...
  {
    id: "chilli-chicken-calzone",
    name: "Chilli Chicken Calzone",
    category: "starters",
    price: 165,
    description:
      "Stuffed with spicy chilli chicken and sealed in a golden-baked calzone",
    nutrition: { protein: 25, carbs: 51, fat: 24 },
    quantity: "1 piece",
    bestseller: false,
    veg: false,
    image:
      "https://i.ytimg.com/vi/hkKwxn68Svs/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLClJ8sfjUSkhbFrMs1C8z3rnDJnmg",
    model: dishModel,
  },
  {
    id: "lemonade",
  ...
  },
  {
    ...
    price: 269,
    description:
      "Refreshing lemonade made bursting with fresh and tangy flavors",
    nutrition: { protein: 0, carbs: 100, fat: 0 },
    quantity: "750 ml",
    bestseller: false,
    veg: true,
    image:
      "https://www.craftmix.com/cdn/shop/files/classic-lemonade-faq-img.png?v=1748654339",
    model: require("./models/salad_plate.glb"),
  },
  {
    ...
    veg: true,
    image:
      "https://static1.squarespace.com/static/58010cc3e58c6267bfeeb21d/t/5801254814fd8378470b6346/1430396349103/1000w/strawberry-tea.jpg",
    model: require("./models/salad_plate.glb"),
  },
  {
    id: "grilled-chicken",
  ...
  },
  {
    ...
    category: "main",
    price: 450,
    description: "Creamy pasta with fresh shrimp and herbs.",
  ...
  },
  {
    ...
    nutrition: { protein: 35, carbs: 8, fat: 20 },
    quantity: "1 plate",
    bestseller: true,
    veg: false,
    image:
  ...
  },
  {
    ...
    nutrition: { protein: 15, carbs: 40, fat: 12 },
    quantity: "1 pizza",
    bestseller: false,
    veg: true,
    image:
